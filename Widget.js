  ...
  function (declare, _WidgetsInTemplateMixin, Button,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      startup: function () {
        ...
        on(this.coordSystemSelect, "change", this.updateCoordinateLabels);

        // updateCoordinateLabels()
        var t = this
        on(t.coordSystemSelect, "change", function () {
          ;

          console.log(t.coordSystemSelect)

          if (t.coordSystemSelect.value == 27039) {


            t.xCoordLabel.innerHTML = "X:";
            t.yCoordLabel.innerHTML = "Y:";
          }
          else if (t.coordSystemSelect.value == 4326) {

            t.yCoordLabel.innerHTML = "Latitude:";
            t.xCoordLabel.innerHTML = "Longitude:";
          }
        })
        ...
        on(this.locate, 'click', lang.hitch(this, function (evt) {
          ...
          xCoord = this.xCoordTextBox.get('value');
          yCoord = this.yCoordTextBox.get('value');

          // If coordinate system selected 4326
          if (this.coordSystemSelect.value == 4326) {
           ...
           // If coordinate system selected 27039
          else {
            // If valid input
        ...
        on(this.clearcoordinates, 'click', lang.hitch(this, function (evt) {
      ...
      _loadUI: function () {
        ...
        //setting default label for coordinate
      ...
      coordSystemSelectchange: function (evt) {
        ...
        if (this.config.GcsWkid.includes(evt)) {
          ...
          for (var a = 0; a < len; a++) {
            ...
            this.coordTypeSelect.addOption(option);
            this.yCoordTextBox.innerText = "Lat";
            this.xCoordTextBox.innerText = "Long";
            _projectedType = "DD";
          };
        } else {
          var len = this.config.projectedCoordinateType.length;
      ...
      _clickIncidentComplete: function (geom) {
        ...
        this._getIncidentAddress(geom);


      },

      _projectTONahrwan: function (e) {
        ...
        if(e.geometry.type=="polyline"){
          ...
          const point = new Point({
            latitude: e.geographicGeometry.y,
            longitude: e.geographicGeometry.x
          })
          if (this.coordSystemSelect.value == 4326) {
            this._displaywgs(e)
          } else {
        ...
        else if(e.geometry.type=="polygone"){
          this.xCoordTextBox.set("value", );
          this.yCoordTextBox.set("value", );
      ...
      _displaywgs: function (e) {
        console.log(e)
        if (this.coordTypeSelect.value == "DD") {
          this.xCoordTextBox.set("value", (e.geographicGeometry.x).toFixed(2));
          this.yCoordTextBox.set("value", (e.geographicGeometry.y).toFixed(2));
        }
        else if (this.coordTypeSelect.value == "DDM") {
          wgslon=e.geographicGeometry.x
          wgslat=e.geographicGeometry.y
          // set lonArray equal to inlon
